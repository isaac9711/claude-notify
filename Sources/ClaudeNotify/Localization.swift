...
enum L10n {
    private static let strings: [String: [String: String]] = [
        ...
        "maxTokens": [
            "en": "Max tokens reached",
            "ko": "최대 토큰 도달",
            "zh": "已达到最大令牌数",
            "ja": "最大トークンに到達",
            "es": "Tokens máximos alcanzados",
            "vi": "Đã đạt token tối đa",
            "pt": "Tokens máximos atingidos",
        ],
        "stopped": [
            "en": "Stopped",
            "ko": "중지됨",
        ...
        "workspaceBase": [
            "en": "Base Project (recommended)",
            "ko": "베이스 프로젝트 (권장)",
            "zh": "基础项目（推荐）",
            "ja": "ベースプロジェクト（推奨）",
            "es": "Proyecto base (recomendado)",
            "vi": "Dự án gốc (khuyến nghị)",
            "pt": "Projeto base (recomendado)",
        ],
        "workspaceWorktree": [
            "en": "Per Worktree",
            "ko": "Worktree별",
